  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) {
    ...
    FirebaseFirestore.instance
      ...
      if (snapshot.docs.isNotEmpty) {
        String uid =
            (snapshot.docs[0].data() as Map<String, dynamic>)['uid'] as String;
        ...
        Map<String, dynamic> data = {
          ...
          'selectedTime':
              selectedTime!.format(context), // Add the selected time
        };

        // Save the data to Firebase collection
        FirebaseFirestore.instance.collection('rides').add(data).then((value) {
              ...
              children: [
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        hintText: 'Enter Starting PostCode',
                        prefixIcon: Icon(
                        ...
                        hintStyle: TextStyle(
                            color: Colors.black, fontFamily: "UberReg"),
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    controller: end,
                    decoration: InputDecoration(
                        hintText: 'Enter Ending PostCode',
                        hintStyle: TextStyle(fontFamily: "UberReg",color: Colors.black),
                        prefixIcon: Icon(
                          Icons.location_city,
                          color: Colors.black,
                        ),
